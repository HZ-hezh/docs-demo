...
const easterEggType = ref('') // 彩蛋类型：'egg22' 或 'egg99'
...
const addSupport = () => {
  ...
  // 检查是否触发彩蛋
  if (clickCount.value === 22) {
    triggerEasterEgg('egg22')
  } else if (clickCount.value === 99) {
    triggerEasterEgg('egg99')
  }
...
<div class="support-container">
  <button 
    ...
    @click="addSupport"
    :class="{ 'egg22-active': easterEggType === 'egg22' && showEasterEgg, 
              'egg99-active': easterEggType === 'egg99' && showEasterEgg }"
  >
    点击助力 👍
    <span 
  ...
  <div v-if="showEasterEgg" class="easter-egg" :class="easterEggType">
    <template v-if="easterEggType === 'egg22'">
      <div class="egg-content">恭喜发现彩蛋！22连击成就达成！🎉</div>
    </template>
    <template v-else-if="easterEggType === 'egg99'">
      <div class="egg-content">
        ...
        <div class="super-achievement">超神！99连击成就达成！🏆</div>
      </div>
    </template>
  </div>
  
  <!-- 显示当前点击次数（可选，调试用） -->
  <div class="click-counter">连击次数: {{ clickCount }}</div>
</div>
