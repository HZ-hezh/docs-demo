...
![VitePress Logo](https://vitepress.dev/vitepress-logo-large.webp "VitePress官方Logo")

![Vue.js Logo](https://vuejs.org/images/logo.png "Vue.js官方Logo")

### 响应式图片

<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin: 20px 0;">
  <div>
    <img src="https://picsum.photos/400/300?random=1" alt="随机图片1" style="width: 100%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
    <p style="text-align: center; margin-top: 10px; color: #666;">随机图片1</p>
  </div>
  <div>
    <img src="https://picsum.photos/400/300?random=2" alt="随机图片2" style="width: 100%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
    <p style="text-align: center; margin-top: 10px; color: #666;">随机图片2</p>
  </div>
  <div>
    <img src="https://picsum.photos/400/300?random=3" alt="随机图片3" style="width: 100%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
    <p style="text-align: center; margin-top: 10px; color: #666;">随机图片3</p>
  </div>
</div>

### 带链接的图片

[![VitePress官网](https://vitepress.dev/vitepress-logo-large.webp "点击访问VitePress官网")](https://vitepress.dev)

### 图片说明

::: tip 图片使用说明
- 图片文件应放在 `public` 目录下
- 使用相对路径 `/images/filename.jpg` 来引用图片
- 支持 JPG、PNG、WebP、SVG 等格式
- 可以使用 HTML 标签实现更复杂的图片布局
- 如果使用本地图片，请确保文件存在
:::
...
<div style="display: flex; justify-content: center; gap: 20px; margin: 30px 0;">
  ...
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vue/vue-original.svg" alt="Vue.js" width="50" height="50">
...
如果你想使用本地图片，请将图片文件放在 `public/images/` 目录下，然后使用以下格式：
...
<div style="background: #f5f5f5; padding: 20px; border-radius: 8px; text-align: center; margin: 20px 0;">
  <p style="color: #666; margin: 0;">📁 这里可以放置你的本地图片</p>
  <p style="color: #999; font-size: 14px; margin: 5px 0 0 0;">将图片放在 public/images/ 目录下</p>
</div>
