...
const coreMembers = [
  {
    avatar: 'https://www.github.com/HZ-hezh.png',
    name: 'Soybean',
    title: '作者',
    desc: 'SoybeansJS团队创始者，SoybeansAdmin作者。',
    links: [
  ...
  },
  {
    ...
    name: 'paynezhuang',
    title: '后端开发',
    desc: '热爱新技术，探究新技术的应用和实践，并在实际的项目中使用',
    links: [
      { icon: 'github', link: 'https://github.com/' }
    ]
  },
...
<div class="team-section">
  <h2 class="team-title">团队成员</h2>
  <p class="team-subtitle">
    我们是一个充满活力的技术团队，致力于为开发者提供优质的技术资源和工具。<br>
    每个成员都在各自的领域发挥着重要作用，共同推动项目的发展。
  </p>
  ...
  <div class="section-divider">
    <h3 class="section-title">贡献者</h3>
    <p class="section-description">
      感谢这些优秀的贡献者，他们为项目的发展做出了重要贡献
    </p>
